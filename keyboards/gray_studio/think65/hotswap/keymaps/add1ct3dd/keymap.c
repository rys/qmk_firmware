...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_ansi_blocker(
        ...
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_NUHS, S(KC_NUBS),
    ...
    [1] = LAYOUT_65_ansi_blocker(
        ...
        KC_NUBS, ESC_HUD, ESC_SAD, ESC_VAD, BDG_HUD, BDG_SAD, BDG_VAD, UGL_HUD, UGL_SAD, UGL_VAD, _______, _______,          CYC_LED, _______,
